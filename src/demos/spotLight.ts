...
import { limitOptionsFn, radToDegOptions } from "../utils/gui"
...
export class SpotLight extends Base {
    ...
    static destroy(): void {
        ...
        this.innerLimitValue = Float32ArrayNull
        this.outerLimitValue = Float32ArrayNull
    }
    ...
    protected static initGUI() {
        ...
        const limitOptions = limitOptionsFn();
