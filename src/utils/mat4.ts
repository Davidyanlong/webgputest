import { vec3, vec3Type } from "./vec3";
...
export const mat4 = {
    ...
    translation([tx, ty, tz]: [number, number, number], dst?: Float32Array) {
        dst = dst || new Float32Array(16);
        dst[0] = 1; dst[1] = 0; dst[2] = 0; dst[3] = 0;
        dst[4] = 0; dst[5] = 1; dst[6] = 0; dst[7] = 0;
        dst[8] = 0; dst[9] = 0; dst[10] = 1; dst[11] = 0;
    ...
    rotationX(angleInRadians: number, dst?: Float32Array) {
    ...
    rotationY(angleInRadians: number, dst?: Float32Array) {
        const c = Math.cos(angleInRadians);
        const s = Math.sin(angleInRadians);
        dst = dst || new Float32Array(16);
    ...
    rotationZ(angleInRadians: number, dst?: Float32Array) {
        const c = Math.cos(angleInRadians);
        const s = Math.sin(angleInRadians);
        dst = dst || new Float32Array(16);
    ...
    scaling([sx, sy, sz]: [number, number, number], dst?: Float32Array) {
        dst = dst || new Float32Array(16);
    ...
    translate(m: Float32Array, translation: [number, number, number], dst?: Float32Array) {
    ...
    rotate(m: Float32Array, axis: vec3Type, angleInRadians: number, dst?: Float32Array) {
        dst = dst || new Float32Array(16);
        let x = axis[0];
        let y = axis[1];
        let z = axis[2];
    ...
    scale(m: Float32Array, scale: [number, number, number], dst?: Float32Array) {
        return mat4.multiply(m, mat4.scaling(scale), dst);
    },
    inverse(m: Float32Array, dst?: Float32Array) {
        dst = dst || new Float32Array(16);
